<!--
  ...
  Version Changed : 2022-11-28
  
  Last Update Changes : 
  * Added 'class_condition' for fields
  * Added 'emit_full' for fields
  * Added documentation for 'fields' below props
  * Added 'process_data' for manually inputted data as well
  * Added additional check for fields to disable sorting when 'paginationExist' is false
-->
<template>
